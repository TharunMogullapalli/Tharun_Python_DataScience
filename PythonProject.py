...
for idx, gs in enumerate(grids):
    plt.plot(grid_dict[idx],gs.best_score_,color = 'blue',label = 'training score')
    plt.plot(grid_dict[idx],accuracy_score(YNew_test, y_pred),color = 'red',label = 'test score')
